    ...
    <div class="main-container">
        ...
        <div class="map-area">
           ...
           @restaurant-selected="handleRestaurantSelected" -->
            <MapComponent :restaurants="restaurants" :selectedRestaurantId="selectedRestaurantId"
                @restaurant-selected="handleRestaurantSelected" />
            <!-- 1. 사이드바 (View) -->
...
// --- 라이프사이클 훅 ---
onMounted(() => {
    // 'HomeView'가 마운트되면, '전체 맛집' 목록을 로드합니다.
...
.ol-popup {
    ...
    bottom: 12px;
    left: 0;
    /* MapComponent가 좌표 기준으로 위치를 재설정함 */
    min-width: 150px;
    white-space: nowrap;
    /* 팝업이 숨겨진 상태 (MapComponent가 보이게 함) */
    display: none;
}
